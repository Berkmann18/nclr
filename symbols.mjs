...
const extend = (extension) => {
  for (let key in extension) {
    ...
    exports.cache[key] = (...data) => log(clr[key](fig[extension[key].symbol] + ' ' + data.join(' ')) + '\n');
  }
  updateTheme();
};

export { error, info, dbg, out, inp, warn, quest, succ, log, extend, use, restoreTheme as restore }